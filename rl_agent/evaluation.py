...
if __name__ == "__main__":
      evaluate(trainee_role= "catcher",model_path="catchy_run/trained_model_checkpoints/catcher_models/catchy_run_catcher_stage1_v0_1", n_episodes=400, )
      # Catcher evaluation example:
      # evaluate(trainee_role="catcher", model_path="catchy_run_catcher_stage1_v0", n_episodes=400)
      #python3 -m catchy_run.rl_agent.evaluation
