...
if __name__ == "__main__":
    ...
    train(load_from= None,total_timesteps= 300000,trainee_role="catcher", save_to="catchy_run/trained_model_checkpoints/catcher_models/catchy_run_catcher_stage1_v0_0", tb_log_name="catcher_stage1_v0_0", ent_coef=0.05, learning_rate=1e-4)
