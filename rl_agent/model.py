...
if __name__ == "__main__":
    ...
    train(load_from= "trained_model_checkpoints/catcher_models/catchy_run_catcher_stage1_v0",total_timesteps= 500000,trainee_role="catcher", save_to="trained_model_checkpoints/catcher_models/catchy_run_catcher_stage1_v1", tb_log_name="catcher_stage1_v1", ent_coef=0.05, learning_rate=2e-4)
